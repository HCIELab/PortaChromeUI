...
int PAINT_WIN_CENTER_X = PAINT_WIN_LEFT_TOP_X + SUB_WIN_WIDTH/2 ; // 400
int PAINT_WIN_CENTER_Y = PAINT_WIN_LEFT_TOP_Y + SUB_WIN_HEIGHT/2; // 500

int FIBER_WIN_LEFT_TOP_X = PAINT_WIN_LEFT_TOP_X + SUB_WIN_SPACING; // 750
